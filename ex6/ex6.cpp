...
int main() {
	...
	******************/
	...
	// 创建着色器
	Shader simpleDepthShader("../../ex6/shadow_mapping_depth.vs.glsl", "../../ex6/shadow_mapping_depth.fs.glsl");
	...
	glUniform1i(glGetUniformLocation(cubeShader.ID, "diffuseTexture"), 0);
	...
	int mode = 0;
	float radius = 1.5f, circlePos = 0.0f, posY = 0.8f;
